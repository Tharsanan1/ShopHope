...
namespace ShopHope
{
    public partial class StockManagerForm : Form
    {
        ...
        {
            if(!(newCatagoryTxt.Text.Length>0 && newBrandTxt.Text.Length>0 && newNameTxt.Text.Length>0 && newWeightTxt.Text.Length>0 && newQuantityTxt.Text.Length>0 && newWarningLevelTxt.Text.Length>0)) {
